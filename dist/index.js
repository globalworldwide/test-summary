...
module.exports = {
  parse: __nccwpck_require__(4653),
  stringify: __nccwpck_require__(4869),
}
...
const customTags = __nccwpck_require__(3151)
...
const {stringifyString} = __nccwpck_require__(3858)
...
const { YAMLMap } = __nccwpck_require__(2903)
const { parseMap } = __nccwpck_require__(3858)
...
class YAMLDomain extends YAMLMap {
  ...
  set tag (_) {}
  toJSON(_, ctx) {
    return (__nccwpck_require__(3639).create)()
  }
}
...
module.exports = {
  identify: value => value && typeof value === 'object' &&
    ...
    ? value instanceof ((__nccwpck_require__(3639).Domain))
    : false,
  tag,
  resolve,
  createNode,
...
const types = __nccwpck_require__(4709)
...
const util = __nccwpck_require__(7636)
